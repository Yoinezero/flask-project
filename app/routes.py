...
from app.forms import (LoginForm, RegistrationForm, EditProfileForm, PostForm, PasswordResetRequestForm,
                       ResetPasswordForm)
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('login'))
    return render_template('email/pwd_reset.jinja2', title='Reset Password', form=form)
...
def reset_password(token: str):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('login'))
    return render_template('reset_password.jinja2', form=form)
