...
def index():
    ...
    posts = current_user.get_actual_posts().all()
    return render_template('index.jinja2', title='Blog', form=form, posts=posts)
...
def explore():
    ...
    return render_template('index.jinja2', title='Explore', posts=posts)
